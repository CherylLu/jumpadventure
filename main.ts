...
sprites.onCreated(SpriteKind.trampoline, function (sprite) {
    sprite.x = randint(0, scene.screenWidth())
    sprite.y = randint(30, scene.screenHeight())
})
...
game.onUpdateInterval(5000, function () {
    shark = sprites.create(img`
        ...
        ff......cc......
        `, SpriteKind.Enemy)
    shark.setPosition(randint(0, scene.screenWidth()), randint(30, scene.screenHeight()))
})
